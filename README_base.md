...
and is made up of the following files.
  ...
  - [process_video.py](_modules/process_video.html) -
  ...
  - [utils.py](_modules/utils.html),
    [config.py](_modules/config.html) and
    [display.py](_modules/display.html) -
...
[combine_binary](_modules/lane_line.html#combine_binary),
[threshold](_modules/lane_line.html#threshold) and
functions.
...
[perspective_transform_map](_modules/lane_line.html#perspective_transform_map) and
...
[fit_poly](_modules/lane_line.html#fit_poly),
[get_poly](_modules/lane_line.html#get_poly) and
[fit_poly_noslide](_modules/lane_line.html#fit_poly_noslide)
functions.
...
<tr><td>1</td><td>
In the
<a href="_modules/lane_line.html#fit_poly">fit_poly</a> <!--_-->
...
<tr><td>6</td><td>
The
<a href="_modules/lane_line.html#get_poly">get_poly</a> <!--_-->
...
<tr><td>7</td><td>
The
<a href="_modules/lane_line.html#fit_poly_noslide">fit_poly_noslide</a> <!--_-->
...
The code could be improved as follows.
  ...
  - Complete the convolution curve fitting algorithm that was partially coded in the
    [find_windows_centroids](_modules/lane_line.html#find_window_centroids)
